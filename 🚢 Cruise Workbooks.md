...
|--------|-------------|--------|
| **AI-Learning-Workbooks** | Learning AI/ML concepts with hands-on experiments and prompt engineering examples | 🟢 Active |
| **Bayes Theorem** | Dedicated workbook exploring Bayesian inference and probability | 🟢 Active |
| **Costco_Price_Auditor** | Practical tool for tracking and auditing Costco prices over time | 🟢 Active |
...
- Interactive notes and strategy analyses
...
- Hands-on model implementations
- Prompt engineering examples
- Integration with various AI models and APIs

### 📊 FFT Workbook
Signal processing fundamentals:
- Frequency analysis and transformations
...
|---------|--------|-------------|
| AI-Learning-Workbooks | 🟢 Active | June 2026 |
| Bayes Theorem | 🟢 Active | July 2026 |
| Costco_Price_Auditor | 🟢 Active | April 2026 |
